...
const ROL_API = 'services/admin/rol.php';
        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button id="btn1" type="button" class="btn" onclick="openUpdate(${row.id_rol})">
                            <i class="bi bi-pencil-fill"></i>
                        </button>
                        <button id="btn2" type="button" class="btn" onclick="openDelete(${row.id_rol})">
                            <i class="bi bi-trash-fill"></i>
                        </button>
                        <button id="btn3" type="button" class="btn" onclick="openReportByRol(${row.id_rol})">
